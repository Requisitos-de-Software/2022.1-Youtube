...
| :-: | :-------- | :-----: | :-: |
| RF01 | O usuário deve ser capaz de postar um vídeo. | Brainstorm<br/>Entrevista<br/>Introspecção | 3 |
| RF02 | O usuário deve poder assistir um vídeo. | Brainstorm<br/>Entrevista<br/>Introspecção | 3 |
| RF03 | O criador de conteúdo deve poder editar o título do próprio vídeo. | Brainstorm<br/>Introspecção | 0.5 |
| RF04 | O usuário deve ser capaz de comentar um vídeo. | Brainstorm<br/>Introspecção | 1 |
| RF05 | O usuário deve ser capaz de avaliar (curtir ou não) um vídeo. | Brainstorm<br/>Introspecção<br/>Observação | 1 |
| RF06 | O usuário deve ser capaz de compartilhar um vídeo. | Brainstorm<br/>Introspecção | 1|
| RF07 | O usuário deve poder criar um canal. | Brainstorm<br/>Introspecção | 2 |
| RF08 | O usuário deve poder criar uma playlist. | Brainstorm<br/>Introspecção | 0.5 |
| RF09 | O usuário deve ser capaz de excluir um canal. | Brainstorm | 1 |
| RF010 | O usuário deve poder excluir uma playlist. | Brainstorm<br/>Introspecção | 0 | 
| RF011 | O criador de conteúdo deve poder excluir um vídeo postado por ele. | Brainstorm<br/>Introspecção | 1 |
| RF012 | O usuário deve poder adicionar um vídeo a uma playlist. | Brainstorm<br/>Introspecção<br/>Observação | 0.5 |
| RF013 | O usuário deve ser capaz de excluir um vídeo de uma playlist. | Brainstorm | 0 |
| RF014 | O usuário deve poder editar ou remover um comentário. | Brainstorm<br/>Observação<br/>Introspecção | 1 |
| RF015 | O usuário deve ser capaz de editar o banner do próprio canal. | Brainstorm<br/>Introspecção | 0 |
| RF016 | O usuário deve poder acelerar ou desacelerar um vídeo. | Brainstorm<br/>Introspecção<br/>Observação | 0.5
| RF017 | O usuário deve ser capaz fazer um clipe de um vídeo. | Brainstorm<br/>Introspecção | 0 |
| RF018 | O usuário deve ser capaz de pular para o próximo vídeo na fila de reprodução. | Brainstorm | 0.5 |
| RF019 | O usuário deve poder alterar a qualidade do vídeo que está assistindo. | Brainstorm<br/>Introspecção | 0.5 |
| RF020 | O criador de conteúdo deve ser capaz de adicionar legenda a um vídeo. | Brainstorm | 0.5 |
| RF021 | O usuário deve ser capaz de acessar vídeos dos canais inscritos. | Brainstorm<br/>Introspecção<br/>Observação | 1 |
| RF022 | O usuário deve poder acionar as notificações de vídeos de um canal. | Brainstorm<br/>Entrevista | 0.5 |
...
| RF059 | O usuário deve ser capaz de alterar as informações de uma playlist | Introspecção | 0 |
...
| 1.1    | 13/07/2022 | Priorização dos requisitos utilizando a técnica do 100dol | @lramon2001 @alef012 | @victorleaoo| 